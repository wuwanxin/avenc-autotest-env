...
def changeYuvFileInfo(cfg_line,src_type,case_info_dict,_codec,out_change_flag):
    ...
    ret = change_line(cfg_line, picx,"--width")
    ret = change_line(ret, picy,"--height")
    #ret = change_line(ret, 0,"--firstPic")
    #ret = change_line(ret, framenum,"--lastPic")
    #ret = change_line(ret, framerate,"--inputRateNumer")
    return ret
